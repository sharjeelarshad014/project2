		...
		<div class="container h-100">
			<div class="banner-content h-100 text-center">
				...
				<ul class="comnp-logos mt-4">
					...
					<li data-aos="zoom-in-up" data-aos-duration="800" class="aos-init aos-animate"><img src="/junaid1/assets/img/mix/comp-2.png" alt=""></li>
					<li data-aos="zoom-in-up" data-aos-duration="1100" class="aos-init aos-animate"><img src="/junaid1/assets/img/mix/comp-3.png" alt=""></li>
					<li data-aos="zoom-in-up" data-aos-duration="1400" class="aos-init aos-animate"><img src="/junaid1/assets/img/mix/comp-4.png" alt=""></li>
				</ul>
			...
			<div class="row justify-content-between">
					...
					<div class="col-lg-4">
						<div class="image-wrap">
							<img src="/junaid1/assets/img/mix/whoweare.png" alt="">
						</div>	
					</div>
			</div>
		</div>
				...
				<div class="row">
						...
						<div class="blog-inner">
							<div class="blog-slider__item">
								<div class="blog-slider__img">
									<img alt="Design" class="finbyz-zoomin" src="/junaid1/assets/img/icons/crm1.png" title="Design">
								</div>
					...
					<div class="col-lg-6">
						<div class="blog-inner">
							<div class="blog-slider__item">
								<div class="blog-slider__img">
									<img alt="Design" class="finbyz-zoomin" src="/junaid1/assets/img/icons/sb1.png" title="Design">
								</div>
								<div class="blog-slider__content">
					...
					<div class="col-lg-6">
						<div class="blog-inner">
							<div class="blog-slider__item">
								<div class="blog-slider__img">
									<img alt="Design" class="finbyz-zoomin" src="/junaid1/assets/img/icons/ci1.png" title="Design">
								</div>
								<div class="blog-slider__content">
					...
					<div class="col-lg-6">
						<div class="blog-inner">
							<div class="blog-slider__item">
								<div class="blog-slider__img">
									<img alt="Design" class="finbyz-zoomin" src="/junaid1/assets/img/icons/ce1.png" title="Design">
								</div>
								<div class="blog-slider__content">
