			...
			<div class="row justify-content-between">
				<div class="col-lg-6 align-self-center">
					<div class="section-content">
						...
						<p class="cl-white"><?php echo"$brandName";?> has helped more than 500 companies in strengthening their brand awareness by creating apps with innovative, and attractive UI/UX Designs. We design customized strategies as per clients' needs. Customer satisfaction fuels us to keep going.</p>
